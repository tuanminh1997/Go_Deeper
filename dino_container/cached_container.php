...
class ProjectServiceContainer extends Container
{
    ...
    protected function getLoggerService()
    {
        ...
        $instance->pushHandler($this->get('logger.std_out_logger'));
        $instance->debug('The logger just got stated');

        return $instance;
    }

    /**
     * Gets the 'logger.std_out_logger' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['logger.stream_handler'] = new \Monolog\Handler\StreamHandler('/home/tuanminh/projects/journey/dino_container/dino.log');
    }
    ...
    {
        return array(
            'root_dir' => '/home/tuanminh/projects/journey/dino_container',
