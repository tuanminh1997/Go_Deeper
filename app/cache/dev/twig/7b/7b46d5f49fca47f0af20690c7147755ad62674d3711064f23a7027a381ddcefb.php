...
class __TwigTemplate_335f1f1f0688b2a02a67c70a3eef62b1aa48bf7318816aed655158e49a3f155d extends \Twig\Template
{
    ...
    {
        // line 1
        if ( !twig_test_empty(($context["token"] ?? $this->getContext($context, "token")))) {
            // line 2
        ...
        <div style=\"margin-bottom: 10px\">&#187;&#160;<a href=\"";
            // line 8
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("_profiler_purge", ["token" => ($context["token"] ?? $this->getContext($context, "token"))]), "html", null, true);
            echo "\">Purge</a></div>
    </div>
";
        }
    ...
    {
        return new Source("{% if token is not empty %}
...
{% endif %}
", "@WebProfiler/Profiler/admin.html.twig", "/home/tuanminh/projects/journey/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Profiler/admin.html.twig");
    }
}
